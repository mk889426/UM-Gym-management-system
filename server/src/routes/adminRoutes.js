...
router.put('/supplements/:id', adminCtrl.updateSupplement)
router.delete('/supplements/:id', adminCtrl.deleteSupplement)


router.post("/diet-details", adminCtrl.createDietDetail);
router.get("/diet-details", adminCtrl.listDietDetails);
router.put("/diet-details/:id", adminCtrl.updateDietDetail);
router.delete("/diet-details/:id", adminCtrl.deleteDietDetail);
